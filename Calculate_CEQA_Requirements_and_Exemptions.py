...
#TEST
#input_parcels_fc = r"P:\Projects3\CDT-CEQA_California_2019_mike_gough\Tasks\CEQA_Parcel_Exemptions\Data\Inputs\Test\Parcels.gdb\sacramento_parcels_subset"
#output_parcels_fc = r"P:\Projects3\CDT-CEQA_California_2019_mike_gough\Tasks\CEQA_Parcel_Exemptions\Data\Outputs\Test\Outputs_for_DataBasin.gdb\sacramento_parcels_requirements"
#output_parcels_fc_mask = r"P:\Projects3\CDT-CEQA_California_2019_mike_gough\Tasks\CEQA_Parcel_Exemptions\Data\Outputs\Test\Outputs_for_DataBasin.gdb\sacramento_parcels_requirements_mask"
...
# Should be REQUIREMENTS to skip.
# Remove any items from the "exemptions_to_skip" list
exemptions_to_skip = [2.6, 3.3, 3.7, 8.4, 9.1, 4.2]
# Test without 2.1, or 2.2 (which take a long time)
#exemptions_to_skip = [2.1, 2.2, 2.6, 3.3, 3.7, 8.4, 9.1, 4.2]


for k, v in exemptions.items():
    new_e_list = []
    for e in v[2]:
        if e not in exemptions_to_skip:
            new_e_list.append(e)
        if isinstance(e, list):
            for sub_e in e:
                if sub_e not in exemptions_to_skip:
                    new_e_list.append(sub_e)
        v[2] = new_e_list
...
def create_parcel_exemptions_table_dev_team(mask):
    ...
    for row in requirements_uc:
        ...
        for k, v in exemptions.iteritems():
            ...
            if k == 5 and parcel_apn == '277-0160-021-0000':
                print "\n"
                print k
                print exemptions[k]
                print parcel_apn
...
additional_requirements_table = r"P:\Projects3\CDT-CEQA_California_2019_mike_gough\Tasks\CEQA_Parcel_Exemptions\Data\Inputs\From_Kai\Transit_and_Infill.gdb\Sacramento_Parcels_MG_v3_Final3"
...
fields_to_join = ["SpecPlan_2_6", "Tran_PriArea_3_3", "B15per_CitAv_3_7"]
...
create_parcel_exemptions_table_dev_team(mask=False)
